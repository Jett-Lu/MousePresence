...
- **Clean shutdown behavior** without forcing system-level failsafes
- **Improved performance** and **more responsive movement**
...
Waypoints (base & variance) | 1 to 30 | Randomized path complexity  
